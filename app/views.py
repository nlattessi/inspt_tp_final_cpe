...
from app.models import (Handheld, Impresora, Vendedor, Incidente, CentroDistribucion, HandheldCambioEstado, ImpresoraCambioEstado)
from app.forms import (HandheldForm,
    HandheldCambiarEstadoForm, HandheldCambiarCentroDistribucionForm,
    HandheldCambiarVendedorForm, ImpresoraCambiarEstadoForm,
    ImpresoraCambiarCentroDistribucionForm, ImpresoraCambiarVendedorForm, 
    IncidenteCargarForm, DispositivoCargarIncidenteForm)
...
def handheld_cambiar_estado(request, id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form.save()
            nuevo_registro_historico = HandheldCambioEstado(handheld=handheld,
